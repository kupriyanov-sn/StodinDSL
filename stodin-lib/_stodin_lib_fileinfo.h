...
{
    extern void file_exists(__stodin_bool & res, const char * name);
    extern void file_exists(__stodin_bool & res, __stodin_string & name);
    ...
    extern void compare_files(__stodin_bool & res, const __stodin_string & file1, const __stodin_string & file2);
    extern void compare_files(__stodin_bool & res, const __stodin_string & file1, const char * file2);
    extern void compare_files(__stodin_bool & res, const char * file1, const __stodin_string & file2);
    extern void compare_files(__stodin_bool & res, const char * file1, const char * file2);
